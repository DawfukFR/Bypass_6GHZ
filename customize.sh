...
set_permissions() {
  ...
  set_perm_recursive $MODPATH/system/vendor/firmware 0 0 0755 0644 u:object_r:same_process_hal_file:s0
  set_perm $MODPATH/system//vendor/firmware/bcmdhd.cal 0 0 0644
}
